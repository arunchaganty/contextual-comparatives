...
public class ConfusionMatrix<U> {
  ...
  /**
   * Add all counts from another contingency table. (micro-average)
   * @param other
   */
  public void addAll(ConfusionMatrix<U> other) {
    other.confTable.forEach((k,v) -> confTable.put(k, confTable.getOrDefault(k, 0) + v));
  }
